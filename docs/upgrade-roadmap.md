...
| Delivery state | Optional approvals, evidence, snapshots, and [strict verification regressions](../plugins/adaptive-sdd/tests/test_delivery_state.py) | Pilot feedback; evidence attribution remains a stated claim |
...
Departmental adoption is an ongoing pilot, primarily using GitHub Spec Kit and Adaptive-SDD guidance. Three-person teams span product ownership, development, and testing; smoke and Playwright testing are being incorporated. No productivity or production-maturity conclusion is recorded.
